...
abstract class AppLocalizations {
  ...
  /// No description provided for @masterDashboardTitle.
  ///
  /// In it, this message translates to:
  /// **'Gestione Globale Patrimonio'**
  String get masterDashboardTitle;
  ...
  ///
  /// In it, this message translates to:
  /// **'Reddito Personale Netto'**
  String get personalIncome;

  /// No description provided for @spouseIncome.
  ///
  /// In it, this message translates to:
  /// **'Reddito Coniuge Netto'**
  String get spouseIncome;

  /// No description provided for @familyIncome.
  ///
  /// In it, this message translates to:
  /// **'Entrate Familiari Totali'**
